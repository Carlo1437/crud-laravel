                    ...
                    <div class="card-body">
                        <table class="table">
                            <tr>
                                ...
                                <td>
                                    <a href="#" onclick="restoreProduct({{ $product->id }})" class="btn btn-dark">restore</a>
                                    <form id="delete-product-form-{{$product->id  }}" action="{{ route('products.restore', $product->id)}}" method="post">
                                    @method('patch')
                                    @csrf
                                </form>
