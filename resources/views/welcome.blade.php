...
<head>
  ...
  <title>McDonald's Online-Book</title>
  <link rel="shortcut icon" href="../foodie-master/assets/images/logo.png" type="image/svg+xml">
...
<body id="top">
    ...
    <div class="container">
      ...
      <h1>
        <a href="#" class="logo flex items-center">
          <img src="{{ asset('build/images/mcdo.png') }}" alt="" height="80" width="80" class="bg-red-800 p-3 rounded-md">
          <span class="ml-0">cDonald's</span>
        </a>
      </h1>
      ...
      <div class="header-btn-group">
        ...
        <a href=" {{ route('auth.registration') }} "><button class="btn btn-hover" id="register_now">Register Now</button></a>
     ...
     <!-- registration form sa mcdonald busheeett -->
     <div id="modal_registration" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-[999] hidden">
      <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-lg md:max-w-2xl mx-4"> <!-- Increased width for larger screens -->
          <!-- Close Button -->
          <div class="flex justify-end">
              <button class="text-gray-500 hover:text-gray-800  text-3xl" id="register_exit">&times;</button>
          </div>

          <!-- McDonald's Logo -->
          <div class="flex justify-center mb-6">
              <img src=" {{ asset('build/images/mcdonaldbrance.jpeg') }}" alt="McDonald's Logo" class="h-35 p-3 w-auto"> <!-- Larger logo -->
          </div>

          <!-- Registration Form -->
          <form action="#" method="POST">
              <h2 class="text-center text-3xl font-bold text-yellow-500 mb-6">Register for McDonald's</h2>

              <!-- Full Name -->
              <div class="mb-6">
                  <label for="name" class="block text-gray-700 text-1xl font-bold mb-2">Full Name:</label>
                  <input type="text" id="name" name="name" placeholder="jelou 0 datu" class="w-full border rounded-lg py-3 px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-yellow-500" >
              </div>

              <!-- Email -->
              <div class="mb-6">
                  <label for="email" class="block text-gray-700 text-1xl font-bold mb-2">Email:</label>
                  <input type="email" id="email" name="email" placeholder="example@gmail.com" class="w-full border rounded-lg py-3 px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-yellow-500" >
              </div>

              <!-- Password -->
              <div class="mb-6">
                  <label for="password" class="block text-gray-700 text-1xl font-bold mb-2 ">Password:</label>
                  <input type="password" id="password" name="password" placeholder="********" class="w-full border rounded-lg py-3 px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-yellow-500" >
              </div>

              <!-- Confirm Password -->
              <div class="mb-6">
                  <label for="confirm_password" class="block text-gray-700 text-1xl font-bold mb-2">Confirm Password:</label>
                  <input type="password" id="confirm_password" name="confirm_password" placeholder="********" class="w-full border rounded-lg py-3 px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-yellow-500" >
              </div>

              <!-- Submit Button -->
              <div class="flex justify-center">
                  <button type="submit" id="alert_register" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-6 rounded-lg w-full">Register</button>
              </div>
          </form>
      </div>
  </div>
  ...
  <main>
    <article>
      ...
      <section class="hero" id="home" style="background-image: url({{ asset('build/images/hero-bg.jpg') }}) ">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <button class="btn" id="sound_alert"><a href="">Book A Table</a></button>

          </div>

          <figure class="hero-banner">
            <img src=" {{ asset('build/images/hero-banner-bg.png') }}" width="820" height="716" alt="" aria-hidden="true"
              class="w-100 hero-img-bg">

            <img src=" {{ asset('build/images/hero-banner.png') }}" width="700" height="637" loading="lazy" alt="Burger"
          ...
          <ul class="promo-list has-scrollbar">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Fried Chicken</h3>

                <p class="card-text">
                  Food is any substance consumed to provide nutritional support for an organism.
                </p>

                <img src=" {{ asset('build/images/6-Pieces-Chicken-McShare-Box.webp')}}" width="300" height="300" loading="lazy" alt="Maxican Pizza"
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('build/images/drinksmc.webp')}}" width="300" height="300" loading="lazy" alt="Soft Drinks"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('build/images/fries.png') }}" width="300" height="300" loading="lazy" alt="French Fry"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('build/images/burgermc.png') }}" width="300" height="300" loading="lazy" alt="Burger Kingo"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src=" {{ asset('build/images/chickenmasala.png') }}" width="300" height="300" loading="lazy" alt="Chicken Masala"
                  class="w-100 card-banner">
      ...
      <section class="section section-divider gray about" id="about">
        <div class="container">
          ...
          <div class="about-banner">
            <img src=" {{ asset('build/images/about-banner.png') }}" width="509" height="459" loading="lazy" alt="Burger with Drinks"
              class="w-100 about-img">

            <img src="{{ asset('build/images/sale-shape-red.png ') }}" width="216" height="226" alt="get up to 50% off now"
          ...
          <div class="about-content">
            ...
            <h2 class="h2 section-title">
              Caferio, Burgers, and Best Fried Chicken
              <span class="span">in Town!</span>
            </h2>

            <p class="section-text">
              The Mcdonald's in Panabo also catered to many northern Davao who had fled south from Kaifeng during
              the Jurchen
      ...
      <section class="section food-menu" id="food-menu">
        <div class="container">
          ...
          <ul class="fiter-list">
            ...
            <li>
              <button class="filter-btn">Fried Chicken</button>
            </li>
            ...
            <li>
              <button class="filter-btn">Fries</button>
            </li>
          ...
          <ul class="food-menu-list">
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('build/images/friedchicken.webp ')}}" width="300" height="300" loading="lazy"
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('build/images/chickenburger.png ')}}" width="300" height="300" loading="lazy"
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('build/images/chickenNuggets.png ')}}" width="300" height="300" loading="lazy"
                ...
                <h3 class="h3 card-title">chicken Nuggets</h3>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src=" {{ asset('build/images/frieschicken.webp ')}}" width="300" height="300" loading="lazy"
                ...
                <h3 class="h3 card-title">French fries</h3>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src=" {{ asset('build/images/zerocola.png ')}}" width="300" height="300" loading="lazy"
                ...
                <div class="wrapper">
                  <p class="category">Soft Drinks</p>
                ...
                <h3 class="h3 card-title">Coca-cola</h3>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('build/images/combomeal.png ')}}" width="300" height="300" loading="lazy"
                ...
                <h3 class="h3 card-title">Fries,Burger,Cocal-cola</h3>
      ...
      <section class="section section-divider white cta" style="background-image: url({{ asset('build/images/hero-bg.jpg')}})">
        <div class="container">

          <div class="cta-content">

            <h2 class="h2 section-title">
              The Mcdonald's Have Excellent Of
              <span class="span">Quality Burgers!</span>
            </h2>

            <p class="section-text">
              The McDonald's in Panabo City also catered to many northern Davao who had fled south from Kaifeng during
              the Jurchen
              invasion of the 1120s, while it is also known that many restaurants were run by families.
            </p>
            <button class="btn btn-hover">Order Now</button>
          ...
          <figure class="cta-banner">
            <img src=" {{ asset('build/images/cta-banner.png')}}" width="700" height="637" loading="lazy" alt="Burger"
              class="w-100 cta-img">

            <img src=" {{ asset('build/images/sale-shape.png')}}" width="216" height="226" loading="lazy"
        ...
        <div class="container">
          ...
          <div class="delivery-content">
            ...
            <p class="section-text">
              The McDonald's in Panabo City also catered to many northern Davao who had fled south from Kaifeng during
              the Jurchen
              invasion of the 1120s, while it is also known that many branches were run by families.
            </p>

          </div>

          <figure class="delivery-banner">
            <img src="{{ asset('build/images/delivery-banner-bg.png ')}}" width="700" height="602" loading="lazy" alt="clouds"
              class="w-100">

            <img src="{{ asset('build/images/delivery-boy.svg ')}}" width="1000" height="880" loading="lazy" alt="delivery boy"
      ...
      <section class="section section-divider white testi">
        <div class="container">
          ...
          <h2 class="h2 section-title">
            Satisfy Your Cravings with <span class="span">McDonald's!</span>
          </h2>
          ...
          <div class="flex justify-center">
         <video src=" {{ asset('build/images/Not just a burger. A QPC..mp4 ')}}" autoplay controls muted class="w-500 h-400"></video>
        </div>
      ...
      <section class="section section-divider gray banner">
        <div class="container">
          <h2 class="h2 section-title">Introducing the Ultimate Collab:
             <span class="span">McDonald's x Pizza Treat!</span>
          </h2>
          <ul class="banner-list">
            ...
            <li class="banner-item banner-lg">
              <div class="banner-card">
                ...
                <img src="{{ asset('build/images/banner-1.jpg ')}}" width="550" height="450" loading="lazy"
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="{{ asset('build/images/banner-2.jpg ')}}" width="550" height="465" loading="lazy" alt="Delicious Pizza"
                  class="banner-img">
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src=" {{ asset('build/images/banner-3.jpg ')}}" width="550" height="465" loading="lazy" alt="American Burgers"
                  class="banner-img">
            ...
            <li class="banner-item banner-md">
              <div class="banner-card">
                ...
                <img src="  {{ asset('build/images/banner-4.jpg ')}}" width="550" height="220" loading="lazy" alt="Tasty Buzzed Pizza"
                  class="banner-img">
          ...
          <ul class="blog-list">
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src="{{ asset('build/images/mcnewchicken.jpg')}}" width="600" height="390" loading="lazy"
                    alt="What Do You Think About Cheese Pizza Recipes?" class="w-100">

                  <div class="badge">Fried Chicken</div>
                </div>
                ...
                <div class="card-content">
                  ...
                  <div class="card-meta-wrapper">
                    ...
                    <a href="#" class="card-meta-link">
                      ...
                      <p class="meta-info">Chef Mike Lingo</p>
                    </a>

                  </div>

                  <h3 class="h3">
                    <a href="#" class="card-title">What Do You Think About Fried Chicken Recipes?</a>
                  </h3>

                  <p class="card-text" id="change_text">
                    Financial experts support or help you to to find out which way you can raise your funds more...
                  </p>

                  <div class="flex gap-2">
                    <button id="change_read_more" class="btn-link"><span>Read More</span></button>
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src=" {{ asset('build/images/burgerrr.jpg')}}" width="600" height="390" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title">Making Cheese Burger With New Delicious Ingridents.</a>
                  </h3>
                  <p class="card-text" id="change_text1">
                    Financial experts support or help you to to find out which way you can raise your funds more...
                  </p>


                  <div class="flex gap-2">
                    <button id="change_read_more1" class="btn-link"><span>Read More</span></button>
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src=" {{ asset('build/images/beefsteak.webp ')}}" width="600" height="390" loading="lazy"
                    alt="Innovative Hot Chessyraw Pasta Make Creator Fact." class="w-100">

                  <div class="badge">Beef Steak</div>
                </div>
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title">With new Ingridents of Beef steaks.</a>
                  </h3>

                  <p class="card-text" id="change_text2">
                    Financial experts support or help you to to find out which way you can raise your funds more...
                  </p>


                  <div class="flex gap-2">
                    <button id="change_read_more2" class="btn-link"><span>Read More</span></button>
  ...
  <footer class="footer" id="contact-us">
    ...
    <div class="footer-top" style="background-image: url({{ asset('build/images/footer-illustration.png ')}})">
      <div class="container">

        <div class="footer-brand">

          <a href="" class="logo">McDonald's<span class="span">.</span></a>

          <p class="footer-text text-black font-bold">
            FOLLOW US ON.
          </p>
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">+63 9156207658</p>
          </li>

          <li>
            <p class="footer-list-item">Jelou@gmail.com</p>
          </li>
        ...
        <form action="" class="footer-form" id="Booktable_form">
